...
// Prüfen, ob der Befehl npm ist
const args = process.argv.slice(2);
const command = process.argv[1].split('/').pop();

if (command === 'npm') {
  console.log('\x1b[31m🚫 npm ist in diesem Projekt gesperrt!\x1b[0m');
...
// Auch npx abfangen
if (command === 'npx') {
  console.log('\x1b[31m🚫 npx ist in diesem Projekt gesperrt!\x1b[0m');
  console.log('\x1b[33mℹ️  Bitte verwenden Sie stattdessen Yarn Berry:\x1b[0m');
