...
yarn version:patch    # Increment patch version (1.4.1 -> 1.4.2)
yarn version:minor    # Increment minor version (1.4.1 -> 1.5.0)
yarn version:major    # Increment major version (1.4.1 -> 2.0.0)
