...
const ValueFilterDialog: React.FC<FilterProps> = ({
  filterState,
  onFilterChange,
  onResetFilter,
  onClose,
  ...
  const t = useTranslations('values.filter')

  const filterFields: FilterField[] = [
    {
      id: 'descriptionFilter',
      label: t('valueStatementContains'),
      type: 'text',
      placeholder: t('valueStatementPlaceholder'),
    },
    {
      id: 'ownerFilter',
      label: t('owner'),
...
export default ValueFilterDialog
