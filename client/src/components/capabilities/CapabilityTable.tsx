...
const CapabilityTable: React.FC<CapabilityTableProps> = ({
  ...
  const mapToFormValues = (capability: BusinessCapability): CapabilityFormValues => {
    return {
      ...
      sovereigntyReqDataResidency: capability.sovereigntyReqDataResidency ?? null,
      sovereigntyReqJurisdictionControl: capability.sovereigntyReqJurisdictionControl ?? null,
      sovereigntyReqOperationalControl: capability.sovereigntyReqOperationalControl ?? null,
      sovereigntyReqInteroperability: capability.sovereigntyReqInteroperability ?? null,
      sovereigntyReqPortability: capability.sovereigntyReqPortability ?? null,
      sovereigntyReqSupplyChainTransparency:
        capability.sovereigntyReqSupplyChainTransparency ?? null,
      sovereigntyReqWeight: capability.sovereigntyReqWeight ?? null,
      sovereigntyReqRationale: capability.sovereigntyReqRationale ?? '',
