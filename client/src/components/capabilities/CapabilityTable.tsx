...
const CapabilityTable: React.FC<CapabilityTableProps> = ({
  ...
  const mapToFormValues = (capability: BusinessCapability): CapabilityFormValues => {
    return {
      ...
      sovereigntyReqStrategicAutonomy: capability.sovereigntyReqStrategicAutonomy ?? null,
      sovereigntyReqResilience: capability.sovereigntyReqResilience ?? null,
      sovereigntyReqSecurity: capability.sovereigntyReqSecurity ?? null,
      sovereigntyReqControl: capability.sovereigntyReqControl ?? null,
      sovereigntyReqWeight: capability.sovereigntyReqWeight ?? null,
      sovereigntyReqStrategicAutonomyRationale: capability.sovereigntyReqStrategicAutonomyRationale ?? '',
