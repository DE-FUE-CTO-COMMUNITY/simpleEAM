...
import { SoftwareProductType, FilterState } from './types'

interface UseSoftwareProductFilterProps {
  softwareProducts: SoftwareProductType[]
}

export const useSoftwareProductFilter = ({
  softwareProducts = [],
}: UseSoftwareProductFilterProps) => {
  ...
  return {
    filterState,
    setFilterState,
    filteredSoftwareProducts: filteredData,
    resetFilters,
  }
}
