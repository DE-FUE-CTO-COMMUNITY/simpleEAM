...
const ApplicationTable: React.FC<ApplicationTableProps> = ({
  ...
  const handleViewApplicationClick = useCallback(
    (id: string) => {
    ...
    [applications, onRowClick]
  )

  // Handler für das Öffnen des Formulars zum Bearbeiten
  const handleEditApplicationClick = useCallback(
    (id: string) => {
      const application = applications.find(app => app.id === id)
      if (application) {
        // Stelle sicher, dass alle erforderlichen Eigenschaften vorhanden sind
  ...
  const handleFormSubmit = useCallback(
    ...
    [formMode, onCreateApplication, onUpdateApplication, selectedApplication]
  )
