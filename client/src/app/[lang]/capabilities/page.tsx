...
const CapabilitiesPage = () => {
  ...
  const handleCreateCapabilitySubmit = async (data: CapabilityFormValues) => {
    ...
    const input = {
      ...
      sovereigntyReqDataResidency: capabilityData.sovereigntyReqDataResidency,
      sovereigntyReqJurisdictionControl: capabilityData.sovereigntyReqJurisdictionControl,
      sovereigntyReqOperationalControl: capabilityData.sovereigntyReqOperationalControl,
      sovereigntyReqInteroperability: capabilityData.sovereigntyReqInteroperability,
      sovereigntyReqPortability: capabilityData.sovereigntyReqPortability,
      sovereigntyReqSupplyChainTransparency: capabilityData.sovereigntyReqSupplyChainTransparency,
      sovereigntyReqWeight: capabilityData.sovereigntyReqWeight,
      sovereigntyReqRationale: capabilityData.sovereigntyReqRationale,
  ...
  const handleUpdateCapabilitySubmit = async (id: string, data: CapabilityFormValues) => {
    ...
    const input: Record<string, any> = {
      ...
      sovereigntyReqDataResidency: { set: capabilityData.sovereigntyReqDataResidency ?? null },
      ...
      sovereigntyReqRationale: { set: capabilityData.sovereigntyReqRationale ?? null },
