...
const CapabilitiesPage = () => {
  ...
  const handleCreateCapabilitySubmit = async (data: CapabilityFormValues) => {
    ...
    const input = {
      ...
      sovereigntyReqStrategicAutonomy: capabilityData.sovereigntyReqStrategicAutonomy,
      sovereigntyReqResilience: capabilityData.sovereigntyReqResilience,
      sovereigntyReqSecurity: capabilityData.sovereigntyReqSecurity,
      sovereigntyReqControl: capabilityData.sovereigntyReqControl,
      sovereigntyReqWeight: capabilityData.sovereigntyReqWeight,
      sovereigntyReqStrategicAutonomyRationale: capabilityData.sovereigntyReqStrategicAutonomyRationale,
  ...
  const handleUpdateCapabilitySubmit = async (id: string, data: CapabilityFormValues) => {
    ...
    const input: Record<string, any> = {
      ...
      sovereigntyReqResilience: {
        set: capabilityData.sovereigntyReqResilience ?? null,
      },
      sovereigntyReqSecurity: {
        set: capabilityData.sovereigntyReqSecurity ?? null,
      },
      sovereigntyReqControl: {
        set: capabilityData.sovereigntyReqControl ?? null,
      },
      sovereigntyReqWeight: { set: capabilityData.sovereigntyReqWeight ?? null },
      sovereigntyReqStrategicAutonomyRationale: { set: capabilityData.sovereigntyReqStrategicAutonomyRationale ?? null },
