  ...
  const handleCreate = async (data: InfrastructureFormValues) => {
    try {
      ...
      const input = {
        ...
        sovereigntyAchStrategicAutonomy: data.sovereigntyAchStrategicAutonomy,
        sovereigntyAchResilience: data.sovereigntyAchResilience,
        sovereigntyAchSecurity: data.sovereigntyAchSecurity,
        sovereigntyAchControl: data.sovereigntyAchControl,
        sovereigntyAchStrategicAutonomyEvidence: data.sovereigntyAchStrategicAutonomyEvidence,
