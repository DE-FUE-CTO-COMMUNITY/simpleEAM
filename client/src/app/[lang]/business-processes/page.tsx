...
const BusinessProcessesPage = () => {
  ...
  const handleUpdateBusinessProcessSubmit = async (
    ...
    const input: Record<string, any> = {
      ...
      tags: { set: tags || [] },
      sovereigntyReqDataResidency: { set: sovereigntyReqDataResidency ?? null },
      sovereigntyReqJurisdictionControl: { set: sovereigntyReqJurisdictionControl ?? null },
      sovereigntyReqOperationalControl: { set: sovereigntyReqOperationalControl ?? null },
      sovereigntyReqInteroperability: { set: sovereigntyReqInteroperability ?? null },
      sovereigntyReqPortability: { set: sovereigntyReqPortability ?? null },
      sovereigntyReqSupplyChainTransparency: {
        set: sovereigntyReqSupplyChainTransparency ?? null,
      },
      sovereigntyReqWeight: { set: sovereigntyReqWeight ?? null },
      sovereigntyReqRationale: { set: sovereigntyReqRationale ?? null },
