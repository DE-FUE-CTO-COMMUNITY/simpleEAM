...
const BusinessProcessesPage = () => {
  ...
  const handleUpdateBusinessProcessSubmit = async (
    ...
    const input: Record<string, any> = {
      ...
      tags: { set: tags || [] },
      sovereigntyReqStrategicAutonomy: { set: sovereigntyReqStrategicAutonomy ?? null },
      sovereigntyReqResilience: { set: sovereigntyReqResilience ?? null },
      sovereigntyReqSecurity: { set: sovereigntyReqSecurity ?? null },
      sovereigntyReqControl: { set: sovereigntyReqControl ?? null },
      sovereigntyReqWeight: { set: sovereigntyReqWeight ?? null },
      sovereigntyReqStrategicAutonomyRationale: { set: sovereigntyReqStrategicAutonomyRationale ?? null },
