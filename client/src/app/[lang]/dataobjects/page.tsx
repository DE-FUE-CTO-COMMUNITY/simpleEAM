  ...
  const handleCreateDataObjectSubmit = async (data: DataObjectFormValues) => {
    try {
      ...
      const input = {
        ...
        sovereigntyReqDataResidency: data.sovereigntyReqDataResidency,
        sovereigntyReqJurisdictionControl: data.sovereigntyReqJurisdictionControl,
        sovereigntyReqOperationalControl: data.sovereigntyReqOperationalControl,
        sovereigntyReqInteroperability: data.sovereigntyReqInteroperability,
        sovereigntyReqPortability: data.sovereigntyReqPortability,
        sovereigntyReqSupplyChainTransparency: data.sovereigntyReqSupplyChainTransparency,
        sovereigntyReqWeight: data.sovereigntyReqWeight,
        sovereigntyReqRationale: data.sovereigntyReqRationale,
