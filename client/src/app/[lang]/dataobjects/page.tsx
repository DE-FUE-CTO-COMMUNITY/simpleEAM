  ...
  const handleCreateDataObjectSubmit = async (data: DataObjectFormValues) => {
    try {
      ...
      const input = {
        ...
        sovereigntyReqStrategicAutonomy: data.sovereigntyReqStrategicAutonomy,
        sovereigntyReqResilience: data.sovereigntyReqResilience,
        sovereigntyReqSecurity: data.sovereigntyReqSecurity,
        sovereigntyReqControl: data.sovereigntyReqControl,
        sovereigntyReqWeight: data.sovereigntyReqWeight,
        sovereigntyReqStrategicAutonomyRationale: data.sovereigntyReqStrategicAutonomyRationale,
