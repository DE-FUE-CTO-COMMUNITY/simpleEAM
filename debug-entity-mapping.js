...
console.log('\n=== Conclusion ===')
console.log('❌ The entity ID mapping is working in our code, but not being applied in the actual mutation')
console.log('❌ The relationship field mapping is working in our code, but not being applied in the actual mutation')
console.log('🔍 Need to check if updatedTabData is correctly passed to updateEntityRelationships function')
